        ...
        try:
            ...
            for teamID in teamIDs:
                ...
                if len(seasonalStats['teamStatsTotals']) == 0:
                    ...
                    # TODO: Add final scores to basic data output
            ...
            # TODO: Combine this column declaration and the one below into a single function
            columns = ['gameID']
            awayColumns = ['prevawayRAPM', 'awayRAPM',  # RAPM stats
                           ...
                           'awayBlkAgainstPerGame', 'awayPtsAgainstPerGame', 'awayFoulsPerGame',
                           'awayFoulsDrawnPerGame',
                           'awayFoulPersPerGame', 'awayFoulPersDrawnPerGame', 'awayPlusMinusPerGame', 'awayWinPct']
            homeColumns = []
            ...
            columns.extend(['awayScore', 'homeScore', 'date', 'awayTeam', 'awayID', 'homeTeam', 'homeID'])
            if config.debug:
